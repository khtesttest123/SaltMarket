<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="java.util.ArrayList, com.saltmarket.common.model.vo.PageInfo, com.saltmarket.product.model.vo.Product, com.saltmarket.product.model.vo.Category " %>
<%
	             ...
	             <div class="col" >
	                 <div class="card" >
	                     ...
	                     <div class="card-body">
	                         ...
	                         <p class="card-text"><%= p.getDescription() %>상품설명</p>
